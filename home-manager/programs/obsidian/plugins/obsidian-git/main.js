...
(function (PluginState) {
    ...
    PluginState[PluginState["checkRepoClean"] = 1] = "checkRepoClean";
...
var ObsidianGit = /** @class */ (function (_super) {
    ...
    ObsidianGit.prototype.onload = function () {
        return __awaiter(this, void 0, void 0, function () {
            var adapter, git, isValidRepo, _a, branchInfo, remote, statusBarEl;
            var _this = this;
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (typeof remote === "string") {
                            ...
                            new obsidian.Notice("Failed to detect remote.");
                            return [2 /*return*/];
                        }
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.pull().then(function (filesUpdated) {
                                                ...
                                                _this.maybeNotice("Pulled new changes. " + filesUpdated + " files updated.");
                                            })];
                        ...
                        this.registerInterval(window.setInterval(function () { return _this.updateStatusBar(); }, 10 * 1000));
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            if (filesUpdated > 0) {
                                                this.maybeNotice("Pulled new changes. " + filesUpdated + " files updated.");
                                            }
                                            else {
                        ...
                        this.addCommand({
                            ...
                            callback: function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.isRepoClean().then(function (isClean) { return __awaiter(_this, void 0, void 0, function () {
                                                var _this = this;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            if (!isClean) return [3 /*break*/, 1];
                                                            this.maybeNotice("No updates detected. Nothing to push.");
                                                            return [3 /*break*/, 3];
                                                        case 1:
                                                            this.maybeNotice("Pushing changes to remote repository..");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        commitMessage = this.settings.commitMessage.replace("{{date}}", new Date().toISOString());
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.git.push(this.settings.remote, this.settings.currentBranch)];
                    case 1:
                        _a.sent();
    ...
    ObsidianGit.prototype.isIdle = function () {
        return this.getState() === PluginState.idle;
    };
    ObsidianGit.prototype.updateStatusBar = function () {
    ...
    ObsidianGit.prototype.maybeNotice = function (text) {
...
var StatusBar = /** @class */ (function () {
    ...
    StatusBar.prototype.displayIdle = function () {
        this.statusBarEl.setText("git: ready");
    };
    StatusBar.prototype.display = function (plugin) {
        switch (plugin.getState()) {
            ...
            case PluginState.pull:
                this.statusBarEl.setText("git: pulling changes from remote repo..");
                break;
        }
    };
    return StatusBar;
